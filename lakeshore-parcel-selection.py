...
import sys,string,os,arcpy,time,datetime,copy,openpyxl                                      # list of modules that will be needed
from datetime import date, timedelta                                                        # extract the sub modules
from openpyxl import load_workbook # for this script alone                                  # extract the sub module
